...
GetPathStats(
        ...
        tSigned32& totalPaths, tSigned32& totalPoints,
        tSigned32& numberFailed
        )
{
    totalPaths = 0;
    totalPoints = 0;
        ...
        )
{
    ...
    tSigned32 totalPaths, totalPoints, numberFailed;
    ...
    tSigned32 successfulPaths = totalPaths - numberFailed;
    if(successfulPaths)
    {
        std::ostringstream os;
